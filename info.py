...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<i><b>ᴛɪᴛʟᴇ</i></b>: <b><a href={url}>{title}</a></b>\nᴅᴜʀᴀᴛɪᴏɴ:<i> {runtime}</i>\nᴀʟsᴏ ᴋɴᴏᴡ ᴀs:<i> {aka}</i>\n<i><b>ʀᴀᴛɪɴɢ</i></b>: <b><a href={url}>IMDb</a></b>⭐️ <i>{rating}/10</i>\n<i><b>ʀᴇʟᴇᴀsᴇ ᴅᴀᴛᴇ</i></b>: <i>{release_date}</i> \n<i><b>ɢᴇɴʀᴇ</i></b> :<i> {genres}</i> \n<i><b>ʟᴀɴɢᴜᴀɢᴇ</i></b>: <i>{languages}</i>\n<i><b>ᴄᴏᴜɴᴛʀʏ ᴏғ ᴏʀɪɢɪɴ</i></b>: <i>{countries}</i>\n\n<i><b>sᴛᴏʀʏ ʟɪɴᴇ</i></b>: <i>{plot}</i>\n\n<i><b>ᴅɪʀᴇᴄᴛᴏʀs</i></b>: <i>{director}</i>\n<i><b>ᴡʀɪᴛᴇʀs </i></b>: <i>{writer}</i>\n<i><b>sᴛᴀʀs</i></b>: <i>{cast}</i>\n\n<i><b>ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ</i></b> : <i>[ғʀᴇᴀᴋᴇʀsғɪʟᴍʏ](https://t.me/freakersfilmy)</i>\n☘𝙅𝙤𝙞𝙣: <i>https://t.me/freakersfilmy</i>\n\n🧐𝙁𝙧𝙚𝙖𝙠𝙚𝙧𝙨🎭𝙁𝙞𝙡𝙢𝙮🍿\n  100% 𝑭𝒂𝒔𝒕 & 𝑸𝒖𝒂𝒍𝒊𝒕𝒚▬▬▬▬▬▬▬▬▬▬▬▬\n")
