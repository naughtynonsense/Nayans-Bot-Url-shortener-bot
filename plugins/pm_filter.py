...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("🫠 𝘚𝘰𝘳𝘳𝘺..!\n𝘖𝘯𝘭𝘺 𝘙𝘦𝘲𝘶𝘦𝘴𝘵𝘦𝘥 𝘗𝘦𝘳𝘴𝘰𝘯 𝘊𝘢𝘯 𝘈𝘤𝘤𝘦𝘴𝘴 𝘛𝘩𝘪𝘴 𝘉𝘶𝘵𝘵𝘰𝘯  𝘠𝘰𝘶 𝘊𝘢𝘯 𝘛𝘳𝘺 𝘛𝘰 𝘙𝘦-𝘴𝘦𝘢𝘳𝘤𝘩 𝘛𝘩𝘦 𝘔𝘰𝘷𝘪𝘦 𝘕𝘢𝘮𝘦..!\n\nതാഴെ ടൈപ്പ് ചെയ്യ്തു ചോദിക്കു എന്നിട്ട് Next അടിക്കു കുഞ്ഞെ...!😁", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("🫠 𝘗𝘭𝘦𝘢𝘴𝘦 𝘚𝘦𝘢𝘳𝘤𝘩🔎 𝘠𝘰𝘶𝘳𝘴𝘦𝘭𝘧\n\nതാഴെ ടൈപ്പ് ചെയ്യ്തു ചോദിക്കു  ..കുഞ്ഞെ...!😁", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('𝑴𝒂𝒏𝒖𝒂𝒍 𝑭𝒊𝒍𝒕𝒆𝒓', callback_data='manuelfilter'),
            InlineKeyboardButton('𝑨𝒖𝒕𝒐 𝑭𝒊𝒍𝒕𝒆𝒓', callback_data='autofilter')
        ], [
            InlineKeyboardButton('𝑪𝒐𝒏𝒏𝒆𝒄𝒕𝒊𝒐𝒏𝒔', callback_data='coct'),
            InlineKeyboardButton('𝑬𝒙𝒕𝒓𝒂𝒔', callback_data='extra')
        ], [
            InlineKeyboardButton('𝑩𝒂𝒄𝒌 𝑻𝒐 𝑯𝒐𝒎𝒆', callback_data='start'),
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝑩𝒂𝒄𝒌', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝑩𝒖𝒕𝒕𝒐𝒏𝒔', callback_data='button')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝑩𝒂𝒄𝒌', callback_data='manuelfilter')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝑩𝒂𝒄𝒌', callback_data='help'),
            InlineKeyboardButton('𝑨𝒅𝒎𝒊𝒏 𝑪𝑴𝑫', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝑩𝒂𝒄𝒌', callback_data='extra')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝑩𝒂𝒄𝒌', callback_data='help'),
            InlineKeyboardButton('𝑹𝒆𝒇𝒓𝒆𝒔𝒉', callback_data='rfrsh')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="🤔𝙃𝙤𝙬 𝙏𝙤 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙❓", url='https://t.me/SixFlix/308')
        ]
    )
